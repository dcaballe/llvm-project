module {
  func.func @vectorize_dynamic_identity(%arg0: tensor<?xf32>, %arg1: tensor<?xf32>, %arg2: tensor<?xf32>) -> tensor<?xf32> {
    ...
    %1 = vector.mask %0 { vector.transfer_read %arg0[%c0_0], %cst {in_bounds = [true]} : tensor<?xf32>, vector<4xf32> } : vector<4xi1> -> vector<4xf32>
    %cst_1 = arith.constant 0.000000e+00 : f32
    %2 = vector.mask %0 { vector.transfer_read %arg1[%c0_0], %cst_1 {in_bounds = [true]} : tensor<?xf32>, vector<4xf32> } : vector<4xi1> -> vector<4xf32>
    %cst_2 = arith.constant 0.000000e+00 : f32
    %3 = vector.mask %0 { vector.transfer_read %arg2[%c0_0], %cst_2 {in_bounds = [true]} : tensor<?xf32>, vector<4xf32> } : vector<4xi1> -> vector<4xf32>
    %4 = arith.addf %1, %2 : vector<4xf32>
    %c0_3 = arith.constant 0 : index
    %5 = vector.mask %0 { vector.transfer_write %4, %arg2[%c0_3] {in_bounds = [true]} : vector<4xf32>, tensor<?xf32> } : vector<4xi1> -> tensor<?xf32>
...
module {
  func.func @vectorize_dynamic_1d_broadcast(%arg0: tensor<?xf32>, %arg1: tensor<?xf32>, %arg2: tensor<?xf32>) -> tensor<?xf32> {
    ...
    %c0_0 = arith.constant 0 : index
    %cst = arith.constant 0.000000e+00 : f32
    %0 = vector.transfer_read %arg0[%c0_0], %cst {permutation_map = #map} : tensor<?xf32>, vector<4xf32>
    %cst_1 = arith.constant 0.000000e+00 : f32
    %1 = vector.create_mask %dim : vector<4xi1>
    %2 = vector.mask %1 { vector.transfer_read %arg1[%c0_0], %cst_1 {in_bounds = [true]} : tensor<?xf32>, vector<4xf32> } : vector<4xi1> -> vector<4xf32>
    %cst_2 = arith.constant 0.000000e+00 : f32
    %3 = vector.mask %1 { vector.transfer_read %arg2[%c0_0], %cst_2 {in_bounds = [true]} : tensor<?xf32>, vector<4xf32> } : vector<4xi1> -> vector<4xf32>
    %4 = arith.addf %0, %2 : vector<4xf32>
    %c0_3 = arith.constant 0 : index
    %5 = vector.mask %1 { vector.transfer_write %4, %arg2[%c0_3] {in_bounds = [true]} : vector<4xf32>, tensor<?xf32> } : vector<4xi1> -> tensor<?xf32>
    return %5 : tensor<?xf32>
  }
  module attributes {transform.with_named_sequence} {
    transform.named_sequence @__transform_main(%arg0: !transform.any_op {transform.readonly}) {
...
module {
  func.func @dynamic_generic_with_reduction_and_broadcast(%arg0: tensor<?x?xf32>, %arg1: tensor<?x?xf32>) -> tensor<?x?xf32> {
    ...
    %1 = vector.mask %0 { vector.transfer_read %arg0[%c0_1, %c0_1], %cst {in_bounds = [true, true]} : tensor<?x?xf32>, vector<4x4xf32> } : vector<4x4xi1> -> vector<4x4xf32>
    %cst_2 = arith.constant 0.000000e+00 : f32
    %2 = vector.create_mask %dim : vector<4xi1>
    %3 = vector.mask %2 { vector.transfer_read %arg1[%c0_1, %c0_1], %cst_2 {in_bounds = [true], permutation_map = #map} : tensor<?x?xf32>, vector<4xf32> } : vector<4xi1> -> vector<4xf32>
    %4 = vector.mask %0 { vector.multi_reduction <add>, %1, %3 [1] : vector<4x4xf32> to vector<4xf32> } : vector<4x4xi1> -> vector<4xf32>
    %c0_3 = arith.constant 0 : index
    %5 = vector.mask %2 { vector.transfer_write %4, %arg1[%c0_3, %c0_3] {in_bounds = [true], permutation_map = #map} : vector<4xf32>, tensor<?x?xf32> } : vector<4xi1> -> tensor<?x?xf32>
...
module {
  func.func @vectorize_dynamic_2d_transpose(%arg0: tensor<?x?xf32>, %arg1: tensor<?x?xf32>, %arg2: tensor<?x?xf32>) -> tensor<?x?xf32> {
    ...
    %1 = vector.mask %0 { vector.transfer_read %arg0[%c0_1, %c0_1], %cst {in_bounds = [true, true], permutation_map = #map} : tensor<?x?xf32>, vector<4x8xf32> } : vector<8x4xi1> -> vector<4x8xf32>
    %cst_2 = arith.constant 0.000000e+00 : f32
    %2 = vector.create_mask %dim, %dim_0 : vector<4x8xi1>
    %3 = vector.mask %2 { vector.transfer_read %arg1[%c0_1, %c0_1], %cst_2 {in_bounds = [true, true]} : tensor<?x?xf32>, vector<4x8xf32> } : vector<4x8xi1> -> vector<4x8xf32>
    %cst_3 = arith.constant 0.000000e+00 : f32
    %4 = vector.mask %2 { vector.transfer_read %arg2[%c0_1, %c0_1], %cst_3 {in_bounds = [true, true]} : tensor<?x?xf32>, vector<4x8xf32> } : vector<4x8xi1> -> vector<4x8xf32>
    %5 = arith.addf %1, %3 : vector<4x8xf32>
    %c0_4 = arith.constant 0 : index
    %6 = vector.mask %2 { vector.transfer_write %5, %arg2[%c0_4, %c0_4] {in_bounds = [true, true]} : vector<4x8xf32>, tensor<?x?xf32> } : vector<4x8xi1> -> tensor<?x?xf32>
...
module {
  func.func @vectorize_dynamic_generic_2d_broadcast(%arg0: tensor<?x?xf32>, %arg1: tensor<?x?xf32>, %arg2: tensor<?x?xf32>) -> tensor<?x?xf32> {
    ...
    %1 = vector.mask %0 { vector.transfer_read %arg0[%c0_1, %c0_1], %cst {in_bounds = [true, true], permutation_map = #map} : tensor<?x?xf32>, vector<4x8xf32> } : vector<8xi1> -> vector<4x8xf32>
    %cst_2 = arith.constant 0.000000e+00 : f32
    %2 = vector.create_mask %dim, %dim_0 : vector<4x8xi1>
    %3 = vector.mask %2 { vector.transfer_read %arg1[%c0_1, %c0_1], %cst_2 {in_bounds = [true, true]} : tensor<?x?xf32>, vector<4x8xf32> } : vector<4x8xi1> -> vector<4x8xf32>
    %cst_3 = arith.constant 0.000000e+00 : f32
...
module {
  func.func @vectorize_dynamic_transpose_reduction(%arg0: tensor<?x?x?xf32>, %arg1: tensor<?x?xf32>) -> tensor<?x?xf32> {
    ...
    %3 = vector.mask %2 { vector.transfer_read %arg1[%c0_2, %c0_2], %cst_3 {in_bounds = [true, true], permutation_map = #map} : tensor<?x?xf32>, vector<8x16xf32> } : vector<16x8xi1> -> vector<8x16xf32>
    %4 = vector.mask %0 { vector.multi_reduction <add>, %1, %3 [0] : vector<4x8x16xf32> to vector<8x16xf32> } : vector<4x8x16xi1> -> vector<8x16xf32>
    %c0_4 = arith.constant 0 : index
    %5 = vector.mask %2 { vector.transfer_write %4, %arg1[%c0_4, %c0_4] {in_bounds = [true, true], permutation_map = #map} : vector<8x16xf32>, tensor<?x?xf32> } : vector<16x8xi1> -> tensor<?x?xf32>
    return %5 : tensor<?x?xf32>
  }
  module attributes {transform.with_named_sequence} {
    transform.named_sequence @__transform_main(%arg0: !transform.any_op {transform.readonly}) {
...
module {
  func.func @vectorize_partial_dynamic_identity(%arg0: tensor<8x?xf32>, %arg1: tensor<8x?xf32>, %arg2: tensor<8x?xf32>) -> tensor<8x?xf32> {
    ...
    %2 = vector.mask %0 { vector.transfer_read %arg1[%c0, %c0], %cst_0 {in_bounds = [true, true]} : tensor<8x?xf32>, vector<8x32xf32> } : vector<8x32xi1> -> vector<8x32xf32>
    %cst_1 = arith.constant 0.000000e+00 : f32
    %3 = vector.mask %0 { vector.transfer_read %arg2[%c0, %c0], %cst_1 {in_bounds = [true, true]} : tensor<8x?xf32>, vector<8x32xf32> } : vector<8x32xi1> -> vector<8x32xf32>
    %4 = arith.addf %1, %2 : vector<8x32xf32>
    %c0_2 = arith.constant 0 : index
    %5 = vector.mask %0 { vector.transfer_write %4, %arg2[%c0_2, %c0_2] {in_bounds = [true, true]} : vector<8x32xf32>, tensor<8x?xf32> } : vector<8x32xi1> -> tensor<8x?xf32>
...
module {
  func.func @do_not_generate_masks(%arg0: tensor<8x32xf32>, %arg1: tensor<8x32xf32>, %arg2: tensor<8x32xf32>) -> tensor<8x32xf32> {
    ...
    %cst_0 = arith.constant 0.000000e+00 : f32
    %1 = vector.transfer_read %arg1[%c0, %c0], %cst_0 : tensor<8x32xf32>, vector<8x32xf32>
    %cst_1 = arith.constant 0.000000e+00 : f32
    %2 = vector.transfer_read %arg2[%c0, %c0], %cst_1 : tensor<8x32xf32>, vector<8x32xf32>
    %3 = arith.addf %0, %1 : vector<8x32xf32>
    %c0_2 = arith.constant 0 : index
    %4 = vector.transfer_write %3, %arg2[%c0_2, %c0_2] : vector<8x32xf32>, tensor<8x32xf32>
...
module {
  func.func @vectorize_static_shape_with_mask(%arg0: tensor<8x30xf32>, %arg1: tensor<8x30xf32>, %arg2: tensor<8x30xf32>) -> tensor<8x30xf32> {
    ...
    %cst_0 = arith.constant 0.000000e+00 : f32
    %2 = vector.mask %0 { vector.transfer_read %arg1[%c0, %c0], %cst_0 {in_bounds = [true, true]} : tensor<8x30xf32>, vector<8x32xf32> } : vector<8x32xi1> -> vector<8x32xf32>
    %cst_1 = arith.constant 0.000000e+00 : f32
    %3 = vector.mask %0 { vector.transfer_read %arg2[%c0, %c0], %cst_1 {in_bounds = [true, true]} : tensor<8x30xf32>, vector<8x32xf32> } : vector<8x32xi1> -> vector<8x32xf32>
    %4 = arith.addf %1, %2 : vector<8x32xf32>
    %c0_2 = arith.constant 0 : index
    %5 = vector.mask %0 { vector.transfer_write %4, %arg2[%c0_2, %c0_2] {in_bounds = [true, true]} : vector<8x32xf32>, tensor<8x30xf32> } : vector<8x32xi1> -> tensor<8x30xf32>
...
module {
  func.func @vectorize_dynamic_fill(%arg0: tensor<?x?xf32>, %arg1: f32) -> tensor<?x?xf32> {
    ...
    %1 = vector.mask %0 { vector.transfer_read %arg0[%c0_1, %c0_1], %cst {in_bounds = [true, true]} : tensor<?x?xf32>, vector<8x16xf32> } : vector<8x16xi1> -> vector<8x16xf32>
    %c0_2 = arith.constant 0 : index
    %2 = vector.broadcast %arg1 : f32 to vector<8x16xf32>
    %3 = vector.mask %0 { vector.transfer_write %2, %arg0[%c0_2, %c0_2] {in_bounds = [true, true]} : vector<8x16xf32>, tensor<?x?xf32> } : vector<8x16xi1> -> tensor<?x?xf32>
...
module {
  func.func @test_masked_vectorize_linalg_transpose(%arg0: tensor<?x?xf32>, %arg1: tensor<?x?xf32>) -> tensor<?x?xf32> {
    ...
    %1 = vector.mask %0 { vector.transfer_read %arg0[%c0_1, %c0_1], %cst {in_bounds = [true, true], permutation_map = #map} : tensor<?x?xf32>, vector<2x4xf32> } : vector<4x2xi1> -> vector<2x4xf32>
    %cst_2 = arith.constant 0.000000e+00 : f32
    %2 = vector.create_mask %dim, %dim_0 : vector<2x4xi1>
    %3 = vector.mask %2 { vector.transfer_read %arg1[%c0_1, %c0_1], %cst_2 {in_bounds = [true, true]} : tensor<?x?xf32>, vector<2x4xf32> } : vector<2x4xi1> -> vector<2x4xf32>
    %c0_3 = arith.constant 0 : index
    %4 = vector.mask %2 { vector.transfer_write %1, %arg1[%c0_3, %c0_3] {in_bounds = [true, true]} : vector<2x4xf32>, tensor<?x?xf32> } : vector<2x4xi1> -> tensor<?x?xf32>
...
module {
  func.func @test_masked_vectorize_linalg_copy(%arg0: memref<?x?xf32>, %arg1: memref<?x?xf32>) {
    ...
    %1 = vector.mask %0 { vector.transfer_read %arg0[%c0_1, %c0_1], %cst {in_bounds = [true, true]} : memref<?x?xf32>, vector<2x4xf32> } : vector<2x4xi1> -> vector<2x4xf32>
    %cst_2 = arith.constant 0.000000e+00 : f32
    %2 = vector.mask %0 { vector.transfer_read %arg1[%c0_1, %c0_1], %cst_2 {in_bounds = [true, true]} : memref<?x?xf32>, vector<2x4xf32> } : vector<2x4xi1> -> vector<2x4xf32>
    %c0_3 = arith.constant 0 : index
    vector.mask %0 { vector.transfer_write %1, %arg1[%c0_3, %c0_3] {in_bounds = [true, true]} : vector<2x4xf32>, memref<?x?xf32> } : vector<2x4xi1>
    return
  }
  module attributes {transform.with_named_sequence} {
    transform.named_sequence @__transform_main(%arg0: !transform.any_op {transform.readonly}) {
...
module {
  func.func @test_masked_vectorize_pad(%arg0: tensor<?x?xf32>, %arg1: index, %arg2: index) -> tensor<2x4xf32> {
    ...
    %c0_0 = arith.constant 0 : index
    %c0_1 = arith.constant 0 : index
    %dim = tensor.dim %arg0, %c0_1 : tensor<?x?xf32>
    %c1 = arith.constant 1 : index
    %dim_2 = tensor.dim %arg0, %c1 : tensor<?x?xf32>
    %0 = vector.create_mask %dim, %dim_2 : vector<2x4xi1>
    ...
    %c0_3 = arith.constant 0 : index
    %3 = vector.transfer_write %1, %2[%c0_3, %c0_3] {in_bounds = [true, true]} : vector<2x4xf32>, tensor<2x4xf32>
...
module {
  func.func @test_masked_vectorize_non_zero_low_pad_unit_res_dim(%arg0: tensor<?x?xf32>, %arg1: index, %arg2: index, %arg3: index) -> tensor<1x4xf32> {
    ...
    %c1 = arith.constant 1 : index
    %dim_2 = tensor.dim %arg0, %c1 : tensor<?x?xf32>
    %0 = vector.create_mask %dim, %dim_2 : vector<1x4xi1>
    ...
    %c0_3 = arith.constant 0 : index
    %3 = vector.transfer_write %1, %2[%c0_3, %c0_3] {in_bounds = [true, true]} : vector<1x4xf32>, tensor<1x4xf32>
...
module {
  func.func @test_vectorize_padded_pack(%arg0: tensor<32x7x15xf32>, %arg1: tensor<32x4x1x16x2xf32>) -> tensor<32x4x1x16x2xf32> {
    ...
    %c0_0 = arith.constant 0 : index
    %5 = vector.transfer_write %3, %4[%c0_0, %c0_0, %c0_0, %c0_0, %c0_0] {in_bounds = [true, true, true, true, true]} : vector<32x4x1x16x2xf32>, tensor<32x4x1x16x2xf32>
...
module {
  func.func @test_vectorize_dynamic_pack(%arg0: tensor<?x?xf32>, %arg1: tensor<?x?x16x2xf32>) -> tensor<?x?x16x2xf32> {
    ...
    %c0_1 = arith.constant 0 : index
    %c0_2 = arith.constant 0 : index
    %dim_3 = tensor.dim %arg0, %c0_2 : tensor<?x?xf32>
    %c1_4 = arith.constant 1 : index
    %dim_5 = tensor.dim %arg0, %c1_4 : tensor<?x?xf32>
    %0 = vector.create_mask %dim_3, %dim_5 : vector<8x16xi1>
    %1 = vector.mask %0 { vector.transfer_read %arg0[%c0_1, %c0_1], %cst {in_bounds = [true, true]} : tensor<?x?xf32>, vector<8x16xf32> } : vector<8x16xi1> -> vector<8x16xf32>
    ...
    %c0_7 = arith.constant 0 : index
    %dim_8 = tensor.dim %4, %c0_7 : tensor<?x?x16x2xf32>
    %c1_9 = arith.constant 1 : index
    %dim_10 = tensor.dim %4, %c1_9 : tensor<?x?x16x2xf32>
    %c16 = arith.constant 16 : index
    %c2 = arith.constant 2 : index
    %5 = vector.create_mask %dim_8, %dim_10, %c16, %c2 : vector<4x1x16x2xi1>
    %6 = vector.mask %5 { vector.transfer_write %3, %4[%c0_6, %c0_6, %c0_6, %c0_6] {in_bounds = [true, true, true, true]} : vector<4x1x16x2xf32>, tensor<?x?x16x2xf32> } : vector<4x1x16x2xi1> -> tensor<?x?x16x2xf32>
...
module {
  func.func @matmul(%arg0: memref<?x?xf32>, %arg1: memref<?x?xf32>, %arg2: memref<?x?xf32>) {
    ...
    %c0_3 = arith.constant 0 : index
    %cst = arith.constant 0.000000e+00 : f32
    %0 = vector.create_mask %dim, %dim_2 : vector<8x4xi1>
    %1 = vector.mask %0 { vector.transfer_read %arg0[%c0_3, %c0_3], %cst {in_bounds = [true, true, true], permutation_map = #map} : memref<?x?xf32>, vector<8x16x4xf32> } : vector<8x4xi1> -> vector<8x16x4xf32>
    %cst_4 = arith.constant 0.000000e+00 : f32
    %2 = vector.create_mask %dim_2, %dim_0 : vector<4x16xi1>
    %3 = vector.mask %2 { vector.transfer_read %arg1[%c0_3, %c0_3], %cst_4 {in_bounds = [true, true, true], permutation_map = #map1} : memref<?x?xf32>, vector<8x16x4xf32> } : vector<4x16xi1> -> vector<8x16x4xf32>
    %cst_5 = arith.constant 0.000000e+00 : f32
    %4 = vector.create_mask %dim, %dim_0 : vector<8x16xi1>
    %5 = vector.mask %4 { vector.transfer_read %arg2[%c0_3, %c0_3], %cst_5 {in_bounds = [true, true]} : memref<?x?xf32>, vector<8x16xf32> } : vector<8x16xi1> -> vector<8x16xf32>
    %6 = arith.mulf %1, %3 : vector<8x16x4xf32>
    %7 = vector.create_mask %dim, %dim_0, %dim_2 : vector<8x16x4xi1>
    %8 = vector.mask %7 { vector.multi_reduction <add>, %6, %5 [2] : vector<8x16x4xf32> to vector<8x16xf32> } : vector<8x16x4xi1> -> vector<8x16xf32>
    %c0_6 = arith.constant 0 : index
    vector.mask %4 { vector.transfer_write %8, %arg2[%c0_6, %c0_6] {in_bounds = [true, true]} : vector<8x16xf32>, memref<?x?xf32> } : vector<8x16xi1>
    return
  }
  module attributes {transform.with_named_sequence} {
    transform.named_sequence @__transform_main(%arg0: !transform.any_op {transform.readonly}) {
...
module {
  func.func @mmt4d(%arg0: memref<16x16x8x1xf32>, %arg1: memref<16x16x8x1xf32>, %arg2: memref<16x16x8x8xf32>) {
    ...
    %cst_3 = arith.constant 0.000000e+00 : f32
    %1 = vector.transfer_read %arg1[%c0, %c0, %c0, %c0], %cst_3 {permutation_map = #map1} : memref<16x16x8x1xf32>, vector<16x16x16x8x8x1xf32>
    %cst_4 = arith.constant 0.000000e+00 : f32
    %2 = vector.transfer_read %arg2[%c0, %c0, %c0, %c0], %cst_4 : memref<16x16x8x8xf32>, vector<16x16x8x8xf32>
    ...
    vector.transfer_write %4, %arg2[%c0_5, %c0_5, %c0_5, %c0_5] : vector<16x16x8x8xf32>, memref<16x16x8x8xf32>
    return
  }
  module attributes {transform.with_named_sequence} {
    transform.named_sequence @__transform_main(%arg0: !transform.any_op {transform.readonly}) {
...
module {
  func.func @matmul_scalable(%arg0: memref<?x?xf32>, %arg1: memref<?x?xf32>, %arg2: memref<?x?xf32>) {
    ...
    %cst = arith.constant 0.000000e+00 : f32
    %0 = vector.create_mask %dim, %dim_2 : vector<8x4xi1>
    %1 = vector.mask %0 { vector.transfer_read %arg0[%c0_3, %c0_3], %cst {in_bounds = [true, true, true], permutation_map = #map} : memref<?x?xf32>, vector<8x[16]x4xf32> } : vector<8x4xi1> -> vector<8x[16]x4xf32>
    %cst_4 = arith.constant 0.000000e+00 : f32
    %2 = vector.create_mask %dim_2, %dim_0 : vector<4x[16]xi1>
    %3 = vector.mask %2 { vector.transfer_read %arg1[%c0_3, %c0_3], %cst_4 {in_bounds = [true, true, true], permutation_map = #map1} : memref<?x?xf32>, vector<8x[16]x4xf32> } : vector<4x[16]xi1> -> vector<8x[16]x4xf32>
    %cst_5 = arith.constant 0.000000e+00 : f32
    %4 = vector.create_mask %dim, %dim_0 : vector<8x[16]xi1>
    %5 = vector.mask %4 { vector.transfer_read %arg2[%c0_3, %c0_3], %cst_5 {in_bounds = [true, true]} : memref<?x?xf32>, vector<8x[16]xf32> } : vector<8x[16]xi1> -> vector<8x[16]xf32>
    %6 = arith.mulf %1, %3 : vector<8x[16]x4xf32>
    %7 = vector.create_mask %dim, %dim_0, %dim_2 : vector<8x[16]x4xi1>
    ...
    %c0_6 = arith.constant 0 : index
    vector.mask %4 { vector.transfer_write %8, %arg2[%c0_6, %c0_6] {in_bounds = [true, true]} : vector<8x[16]xf32>, memref<?x?xf32> } : vector<8x[16]xi1>
    return
  }
  module attributes {transform.with_named_sequence} {
    transform.named_sequence @__transform_main(%arg0: !transform.any_op {transform.readonly}) {
...
module {
  func.func @test_vectorize_dynamic_shapes_unpack(%arg0: tensor<?x?xf32>, %arg1: tensor<?x?x16x2xf32>) -> tensor<?x?xf32> {
    ...
    %c0_1 = arith.constant 0 : index
    %c0_2 = arith.constant 0 : index
    %dim_3 = tensor.dim %arg1, %c0_2 : tensor<?x?x16x2xf32>
    %c1_4 = arith.constant 1 : index
    %dim_5 = tensor.dim %arg1, %c1_4 : tensor<?x?x16x2xf32>
    %c16 = arith.constant 16 : index
    %c2 = arith.constant 2 : index
    %0 = vector.create_mask %dim_3, %dim_5, %c16, %c2 : vector<2x1x16x2xi1>
    %1 = vector.mask %0 { vector.transfer_read %arg1[%c0_1, %c0_1, %c0_1, %c0_1], %cst {in_bounds = [true, true, true, true]} : tensor<?x?x16x2xf32>, vector<2x1x16x2xf32> } : vector<2x1x16x2xi1> -> vector<2x1x16x2xf32>
    ...
    %c0_6 = arith.constant 0 : index
    %c0_7 = arith.constant 0 : index
    %dim_8 = tensor.dim %4, %c0_7 : tensor<?x?xf32>
    %c1_9 = arith.constant 1 : index
    %dim_10 = tensor.dim %4, %c1_9 : tensor<?x?xf32>
    %5 = vector.create_mask %dim_8, %dim_10 : vector<4x16xi1>
    %6 = vector.mask %5 { vector.transfer_write %3, %4[%c0_6, %c0_6] {in_bounds = [true, true]} : vector<4x16xf32>, tensor<?x?xf32> } : vector<4x16xi1> -> tensor<?x?xf32>
    return %6 : tensor<?x?xf32>
  }
  module attributes {transform.with_named_sequence} {
    transform.named_sequence @__transform_main(%arg0: !transform.any_op {transform.readonly}) {
...
module {
  func.func @test_vectorize_unpack(%arg0: tensor<8x8x32x16xf32>, %arg1: tensor<256x128xf32>) -> tensor<256x128xf32> {
    ...
    %c32 = arith.constant 32 : index
    %c16 = arith.constant 16 : index
    %0 = vector.create_mask %c8, %c8_0, %c32, %c16 : vector<16x8x32x16xi1>
    ...
    %6 = vector.mask %5 { vector.transfer_write %3, %4[%c0_1, %c0_1] {in_bounds = [true, true]} : vector<512x128xf32>, tensor<256x128xf32> } : vector<512x128xi1> -> tensor<256x128xf32>
...
module {
  func.func @test_vectorize_unpack_no_masks(%arg0: tensor<8x8x32x16xf32>, %arg1: tensor<256x128xf32>) -> tensor<256x128xf32> {
    ...
    %c0_0 = arith.constant 0 : index
    %4 = vector.transfer_write %2, %3[%c0_0, %c0_0] {in_bounds = [true, true]} : vector<256x128xf32>, tensor<256x128xf32>
...
module {
  func.func @test_vectorize_padded_pack_no_vector_sizes(%arg0: tensor<32x7x15xf32>, %arg1: tensor<32x4x1x16x2xf32>) -> tensor<32x4x1x16x2xf32> {
    ...
    %c0_0 = arith.constant 0 : index
    %4 = vector.transfer_write %2, %3[%c0_0, %c0_0, %c0_0, %c0_0, %c0_0] {in_bounds = [true, true, true, true, true]} : vector<32x4x1x16x2xf32>, tensor<32x4x1x16x2xf32>
...
module {
  func.func @test_vectorize_unpack_no_vector_sizes_permute(%arg0: tensor<4x7x4xf32>, %arg1: tensor<7x16xf32>) -> tensor<7x16xf32> {
    ...
    %c0_0 = arith.constant 0 : index
    %4 = vector.transfer_write %2, %3[%c0_0, %c0_0] {in_bounds = [true, true]} : vector<7x16xf32>, tensor<7x16xf32>
...
module {
  func.func private @insert_slice_static_sizes(%arg0: tensor<?x3x?x1xi32>) -> tensor<5x3xi32> {
    ...
    %c0_0 = arith.constant 0 : index
    %3 = vector.mask %1 { vector.transfer_write %2, %0[%c0_0, %c2] : vector<8x1xi32>, tensor<5x3xi32> } : vector<8x1xi1> -> tensor<5x3xi32>
...
module {
  func.func private @insert_slice_dynamic_dest_dim(%arg0: tensor<?x3x?x1xi32>, %arg1: index) -> tensor<?x3xi32> {
    ...
    %2 = vector.mask %1 { vector.transfer_read %extracted_slice[%c0, %c0], %c0_i32 : tensor<5x1xi32>, vector<8x1xi32> } : vector<8x1xi1> -> vector<8x1xi32>
    %c0_0 = arith.constant 0 : index
    %3 = vector.mask %1 { vector.transfer_write %2, %0[%c0_0, %c2] : vector<8x1xi32>, tensor<?x3xi32> } : vector<8x1xi1> -> tensor<?x3xi32>
