...
// CHECK:    %[[S2:.*]] = scf.for %[[ARG4:.*]] = %[[C0]] to %[[C5]] step %[[C1]] iter_args(%[[ARG5:.*]] = %[[ARG3]])
...
// CHECK-DAG:   %[[C1:.*]] = arith.constant 1 : index
// CHECK:   %[[S1:.*]] = scf.for %[[ARG2:.*]] = %[[C0]] to %[[C2]] step %[[C1]] iter_args(%[[ARG3:.*]] = %[[ARG1]])
// CHECK:     %[[S2:.*]] = scf.for %[[ARG4:.*]] = %[[C0]] to %[[C5]] step %[[C2]] iter_args(%[[ARG5:.*]] = %[[ARG3]])
...
// CHECK-DAG: %[[C1:.*]] = arith.constant 1 : index
// CHECK: %[[S1:.*]] = scf.for %[[ARG2:.*]] = %[[C0]] to %[[C2]] step %[[C1]] iter_args(%[[ARG3:.*]] = %[[ARG1]])
// CHECK: %[[S2:.*]] = scf.for %[[ARG4:.*]] = %[[C0]] to %[[C2]] step %[[C1]] iter_args(%[[ARG5:.*]] = %[[ARG3]])
...
// CHECK: %[[S1:.*]] = scf.for %[[ARG2:.*]] = %[[C0]] to %[[C2]] step %[[C1]] iter_args(%[[ARG3:.*]] = %[[ARG1]])
// CHECK:   %[[S2:.*]] = scf.for %[[ARG4:.*]] = %[[C0]] to %[[C2]] step %[[C1]] iter_args(%[[ARG5:.*]] = %[[ARG3]])
// CHECK:     %[[S3:.*]] = scf.for %[[ARG6:.*]] = %[[C0]] to %[[C2]] step %[[C1]] iter_args(%[[ARG7:.*]] = %[[ARG5]])
// CHECK:       %[[S4:.*]] = scf.for %[[ARG8:.*]] = %[[C0]] to %[[C5]] step %[[C1]] iter_args(%[[ARG9:.*]] = %[[ARG7]])
...
// CHECK-DAG: %[[C2:.*]] = arith.constant 2 : index
// CHECK-DAG: %[[C5:.*]] = arith.constant 5 : index
// CHECK: %[[S1:.*]] = scf.for %[[ARG2:.*]] = %[[C0]] to %[[C2]] step %[[C2]] iter_args(%[[ARG3:.*]] = %[[ARG1]])
// CHECK:   %[[S2:.*]] = scf.for %[[ARG4:.*]] = %[[C0]] to %[[C2]] step %[[C2]] iter_args(%[[ARG5:.*]] = %[[ARG3]])
// CHECK:     %[[S3:.*]] = scf.for %[[ARG6:.*]] = %[[C0]] to %[[C2]] step %[[C2]] iter_args(%[[ARG7:.*]] = %[[ARG5]])
// CHECK:       %[[S4:.*]] = scf.for %[[ARG8:.*]] = %[[C0]] to %[[C5]] step %[[C2]] iter_args(%[[ARG9:.*]] = %[[ARG7]])
...
// CHECK-DAG:   %[[C2:.*]] = arith.constant 2 : index
// CHECK-DAG:   %[[C5:.*]] = arith.constant 5 : index
// CHECK:   %[[S1:.*]] = scf.for %[[ARG2:.*]] = %[[C0]] to %[[C1]] step %[[C1]] iter_args(%[[ARG3:.*]] = %[[ARG1]])
// CHECK:     %[[S2:.*]] = scf.for %[[ARG4:.*]] = %[[C0]] to %[[C2]] step %[[C1]] iter_args(%[[ARG5:.*]] = %[[ARG3]])
// CHECK:       %[[S3:.*]] = scf.for %[[ARG6:.*]] = %[[C0]] to %[[C2]] step %[[C1]] iter_args(%[[ARG7:.*]] = %[[ARG5]])
// CHECK:         %[[S4:.*]] = scf.for %[[ARG8:.*]] = %[[C0]] to %[[C5]] step %[[C1]] iter_args(%[[ARG9:.*]] = %[[ARG7]])
...
// CHECK:     %[[S2:.*]] = scf.for %[[ARG4:.*]] = %[[C0]] to %[[C2]] step %[[C1]] iter_args(%[[ARG6:.*]] = %[[ARG5]]) -> (tensor<2x8x8x2xf32>)
...
// CHECK-DAG:    %[[C5:.*]] = arith.constant 5 : index
// CHECK:    %[[S1:.*]] = scf.for %[[ARG2:.*]] = %[[C0]] to %[[C2]] step %[[C2]] iter_args(%[[ARG9:.*]] = %[[ARG1]]) -> (tensor<3x8x8x5xf32>)
// CHECK:      %[[S2:.*]] = scf.for %[[ARG4:.*]] = %[[C0]] to %[[C2]] step %[[C2]] iter_args(%[[ARG10:.*]] = %[[ARG9]]) -> (tensor<3x8x8x5xf32>)
// CHECK:        %[[S3:.*]] = scf.for %[[ARG6:.*]] = %[[C0]] to %[[C3]] step %[[C2]] iter_args(%[[ARG11:.*]] = %[[ARG10]])
// CHECK:          %[[S4:.*]] = scf.for %[[ARG8:.*]] = %[[C0]] to %[[C5]] step %[[C2]] iter_args(%[[ARG12:.*]] = %[[ARG11]])
...
// CHECK:     %[[S2:.*]] = scf.for %[[ARG4:.*]] = %[[C0]] to %[[C1]] step %[[C1]] iter_args(%[[ARG10:.*]] = %[[ARG9]]) -> (tensor<3x8x1x5xf32>)
// CHECK:       %[[S3:.*]] = scf.for %[[ARG6:.*]] = %[[C0]] to %[[C3]] step %[[C1]] iter_args(%[[ARG11:.*]] = %[[ARG10]]) -> (tensor<3x8x1x5xf32>)
// CHECK:         %[[S4:.*]] = scf.for %[[ARG8:.*]] = %[[C0]] to %[[C5]] step %[[C1]] iter_args(%[[ARG12:.*]] = %[[ARG11]]) -> (tensor<3x8x1x5xf32>)
