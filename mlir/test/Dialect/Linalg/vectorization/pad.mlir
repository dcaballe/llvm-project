    ...
    -> tensor<2x4xf32>
{
  ...
  //      CHECK: vector.transfer_write %[[masked_read]], %[[empty]][%[[c0_0]], %[[c0_0]]]
    ...
    -> tensor<?x?xf32>
{
  ...
  // CHECK-SAME: vector.transfer_write %[[masked_read]], %[[empty]][%[[c0_0]], %[[c0_0]]]
    ...
    -> tensor<1x4xf32>
{
  ...
  //      CHECK: %[[MASKED_WRITE:.*]] = vector.transfer_write %[[MASKED_READ]], %[[EMPTY]][%[[C0_1]], %[[C0_1]]]
