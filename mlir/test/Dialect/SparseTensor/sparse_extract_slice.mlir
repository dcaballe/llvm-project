...
// CHECK:           %[[VAL_8:.*]] = sparse_tensor.storage_specifier.init with %[[VAL_3]]
// CHECK:           %[[VAL_9:.*]] = sparse_tensor.storage_specifier.set %[[VAL_8]]  dim_offset at 0 with %[[VAL_4]]
// CHECK:           %[[VAL_10:.*]] = sparse_tensor.storage_specifier.set %[[VAL_9]]  lvl_sz at 0 with %[[VAL_5]]
// CHECK:           %[[VAL_11:.*]] = sparse_tensor.storage_specifier.set %[[VAL_10]]  dim_stride at 0 with %[[VAL_6]]
// CHECK:           %[[VAL_12:.*]] = sparse_tensor.storage_specifier.set %[[VAL_11]]  dim_offset at 1 with %[[VAL_4]]
// CHECK:           %[[VAL_13:.*]] = sparse_tensor.storage_specifier.set %[[VAL_12]]  lvl_sz at 1 with %[[VAL_7]]
// CHECK:           %[[VAL_14:.*]] = sparse_tensor.storage_specifier.set %[[VAL_13]]  dim_stride at 1 with %[[VAL_6]]
