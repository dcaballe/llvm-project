// RUN: mlir-opt %s -convert-std-to-llvm -convert-std-to-llvm-use-bare-ptr-memref-call-conv | mlir-cpu-runner -shared-libs=%linalg_test_lib_dir/libmlir_runner_utils%shlibext -entry-point-result=void | FileCheck %s
...
// 'call' op is not supported yet by the bare pointer calling convention. The
// LLVM dialect version was generated using the following loop/std dialect
// version but minor changes around the 'simple_add1_add2_test' call.
