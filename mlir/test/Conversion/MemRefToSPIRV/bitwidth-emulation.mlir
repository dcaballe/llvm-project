...
func.func @load_i1(%arg0: memref<i1, #spirv.storage_class<StorageBuffer>>) -> i1 {
  ...
  //     CHECK-DAG: %[[MASK:.+]] = spirv.Constant 255 : i32
  //     CHECK-DAG: %[[T2:.+]] = spirv.Constant 24 : i32
...
func.func @load_i8(%arg0: memref<i8, #spirv.storage_class<StorageBuffer>>) -> i8 {
  ...
  //   INDEX64-DAG: %[[ZERO:.+]] = spirv.Constant 0 : i64
  //   INDEX64-DAG: %[[MASK:.+]] = spirv.Constant 255 : i32
  //   INDEX64-DAG: %[[T2:.+]] = spirv.Constant 24 : i32
...
func.func @load_i16(%arg0: memref<10xi16, #spirv.storage_class<StorageBuffer>>, %index : index) -> i16 {
  ...
  //     CHECK-DAG: %[[SIXTEEN:.+]] = spirv.Constant 16 : i32
  //     CHECK-DAG: %[[MASK:.+]] = spirv.Constant 65535 : i32
...
func.func @store_i1(%arg0: memref<i1, #spirv.storage_class<StorageBuffer>>, %value: i1) {
  //     CHECK-DAG: %[[ZERO:.+]] = spirv.Constant 0 : i32
  //     CHECK-DAG: %[[MASK:.+]] = spirv.Constant -256 : i32
...
func.func @store_i8(%arg0: memref<i8, #spirv.storage_class<StorageBuffer>>, %value: i8) {
  //     CHECK-DAG: %[[ZERO:.+]] = spirv.Constant 0 : i32
  //     CHECK-DAG: %[[MASK1:.+]] = spirv.Constant 255 : i32
  //     CHECK-DAG: %[[MASK2:.+]] = spirv.Constant -256 : i32
  ...
  //   INDEX64-DAG: %[[ZERO:.+]] = spirv.Constant 0 : i64
  //   INDEX64-DAG: %[[MASK1:.+]] = spirv.Constant 255 : i32
  //   INDEX64-DAG: %[[MASK2:.+]] = spirv.Constant -256 : i32
...
func.func @store_i16(%arg0: memref<10xi16, #spirv.storage_class<StorageBuffer>>, %index: index, %value: i16) {
  //     CHECK-DAG: %[[TWO:.+]] = spirv.Constant 2 : i32
  //     CHECK-DAG: %[[SIXTEEN:.+]] = spirv.Constant 16 : i32
  //     CHECK-DAG: %[[MASK1:.+]] = spirv.Constant 65535 : i32
...
func.func @load_i4(%arg0: memref<?xi4, #spirv.storage_class<StorageBuffer>>, %i: index) -> i4 {
  // CHECK-DAG: %[[EIGHT:.+]] = spirv.Constant 8 : i32
  // CHECK-DAG: %[[FOUR:.+]] = spirv.Constant 4 : i32
  // CHECK-DAG: %[[MASK:.+]] = spirv.Constant 15 : i32
  // CHECK-DAG: %[[C28:.+]] = spirv.Constant 28 : i32
...
func.func @store_i4(%arg0: memref<?xi4, #spirv.storage_class<StorageBuffer>>, %value: i4, %i: index) {
  // CHECK-DAG: %[[EIGHT:.+]] = spirv.Constant 8 : i32
  // CHECK-DAG: %[[FOUR:.+]] = spirv.Constant 4 : i32
  // CHECK-DAG: %[[MASK1:.+]] = spirv.Constant 15 : i32
...
func.func @store_i8(%arg0: memref<i8, #spirv.storage_class<StorageBuffer>>, %value: i8) {
  //     CHECK-DAG: %[[ZERO:.+]] = spirv.Constant 0 : i32
  //     CHECK-DAG: %[[MASK1:.+]] = spirv.Constant -256 : i32
  //     CHECK-DAG: %[[ARG0_CAST:.+]] = builtin.unrealized_conversion_cast %[[ARG0]]
  ...
  //   INDEX64-DAG: %[[ZERO:.+]] = spirv.Constant 0 : i64
  //   INDEX64-DAG: %[[MASK1:.+]] = spirv.Constant -256 : i32
  //   INDEX64-DAG: %[[ARG0_CAST:.+]] = builtin.unrealized_conversion_cast %[[ARG0]]
