...
// CHECK: %[[desc1:.*]] = llvm.insertvalue %[[alloca_aligned]], %{{.*}}[0] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)>
...
// CHECK-DAG:  llvm.mlir.poison : !llvm.struct<(i64, ptr)>
...
// CHECK32-DAG:  llvm.mlir.poison : !llvm.struct<(i32, ptr)>
