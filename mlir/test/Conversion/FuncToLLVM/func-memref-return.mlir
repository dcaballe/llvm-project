...
// BAREPTR-NEXT: %[[ins3:.*]] = llvm.insertvalue %[[val2]], %[[ins2]][3, 1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)>
...
func.func @check_memref_func_call(%in : memref<10xi8>) -> memref<20xi8> {
  // BAREPTR:         %[[desc0:.*]] = llvm.mlir.poison : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
  // BAREPTR:         %[[c0:.*]] = llvm.mlir.constant(0 : index) : i64
