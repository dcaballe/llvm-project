...
// CHECK: %[[VAR229:.*]] = complex.create %[[ZERO]], %[[ONE]] : complex<f32>
...
// CHECK: %[[VAR350:.*]] = arith.cmpf oeq, %[[VAR349]], %[[ZERO]] : f32
// CHECK: %[[VAR351:.*]] = math.absf %[[VAR330]] fastmath<nnan,contract> : f32
// CHECK: %[[VAR352:.*]] = arith.cmpf oeq, %[[VAR351]], %[[ZERO]] : f32
// CHECK: %[[VAR353:.*]] = arith.cmpf ord, %[[VAR327]], %[[ZERO]] : f32
// CHECK: %[[VAR354:.*]] = arith.cmpf ord, %[[VAR328]], %[[ZERO]] : f32
// CHECK: %[[VAR355:.*]] = arith.ori %[[VAR353]], %[[VAR354]] : i1
// CHECK: %[[VAR356:.*]] = arith.andi %[[VAR350]], %[[VAR352]] : i1
// CHECK: %[[VAR357:.*]] = arith.andi %[[VAR355]], %[[VAR356]] : i1
// CHECK: %[[VAR358:.*]] = math.copysign %[[INF]], %[[VAR329]] : f32
...
// CHECK: %[[VAR377:.*]] = arith.mulf %[[INF]], %[[VAR376]] fastmath<nnan,contract> : f32
...
// CHECK: %[[VAR381:.*]] = arith.mulf %[[INF]], %[[VAR380]] fastmath<nnan,contract> : f32
// CHECK: %[[VAR382:.*]] = arith.cmpf one, %[[VAR364]], %[[INF]] : f32
// CHECK: %[[VAR383:.*]] = arith.cmpf one, %[[VAR366]], %[[INF]] : f32
// CHECK: %[[VAR384:.*]] = arith.andi %[[VAR382]], %[[VAR383]] : i1
// CHECK: %[[VAR385:.*]] = arith.cmpf oeq, %[[VAR349]], %[[INF]] : f32
// CHECK: %[[VAR386:.*]] = arith.cmpf oeq, %[[VAR351]], %[[INF]] : f32
// CHECK: %[[VAR387:.*]] = arith.ori %[[VAR385]], %[[VAR386]] : i1
// CHECK: %[[VAR388:.*]] = arith.andi %[[VAR384]], %[[VAR387]] : i1
// CHECK: %[[VAR389:.*]] = arith.select %[[VAR385]], %[[ONE]], %[[ZERO]] : f32
// CHECK: %[[VAR390:.*]] = math.copysign %[[VAR389]], %[[VAR329]] : f32
// CHECK: %[[VAR391:.*]] = arith.select %[[VAR386]], %[[ONE]], %[[ZERO]] : f32
...
// CHECK: %[[VAR396:.*]] = arith.mulf %[[ZERO]], %[[VAR395]] fastmath<nnan,contract> : f32
...
// CHECK: %[[VAR400:.*]] = arith.mulf %[[ZERO]], %[[VAR399]] fastmath<nnan,contract> : f32
...
// CHECK: %[[VAR410:.*]] = arith.cmpf uno, %[[VAR402]], %[[ZERO]] : f32
// CHECK: %[[VAR411:.*]] = arith.cmpf uno, %[[VAR403]], %[[ZERO]] : f32
...
// CHECK: %[[VAR441:.*]] = complex.create %[[ZERO]], %[[CST_21]] : complex<f32>
