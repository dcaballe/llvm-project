...
// CHECK:           %[[VAL_2:.*]] = memref.get_global @global_i32 : memref<1xi32>
// CHECK:           memref.store %[[VAL_0]], %[[VAL_2]]{{\[}}%[[VAL_1]]] : memref<1xi32>
...
// CHECK:           %[[VAL_1:.*]] = arith.constant 0 : index
// CHECK:           %[[VAL_2:.*]] = memref.get_global @global_f64 : memref<1xf64>
// CHECK:           memref.store %[[VAL_0]], %[[VAL_2]]{{\[}}%[[VAL_1]]] : memref<1xf64>
